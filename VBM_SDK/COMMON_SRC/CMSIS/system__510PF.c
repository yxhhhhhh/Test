...
void SYS_SetPowerStates(SYS_PowerState_t tPowerState)
{
	switch(tPowerState)
	{
		case SYS_PS0:
			...
			USB_PHY2->FW_CTL_TX	 = 0;
			USB_PHY2->DPPULLDOWN = 0;
			USB_PHY2->DMPULLDOWN = 0;
			USB_PHY2->VBUS_VALID = 1;
			USB_PHY2->PHY_PWR  	 = 1;
			break;
		case SYS_PS1:
			...
			GLB->UD_FUNC_DIS   = 1;
			USB_PHY1->PHY_PWR  	 = 0;
			USB_PHY2->DPPULLDOWN = 1;
			USB_PHY2->DMPULLDOWN = 1;
			USB_PHY2->VBUS_VALID = 0;
			USB_PHY2->PHY_PWR  	 = 0;
			USB_PHY2->FW_CTL_TX	 = 1;
